...
class PlateauScheduler:
    def __init__(self, init_lr, factor=0.1, patience=10, threshold=1e-3):
...
def get_reduce_on_plateau_scheduler(init_lr, factor=0.1, patience=10, threshold=1e-3, min_lr=0, metric_name='metric'):
    class Schedule:
        def __init__(self):
            self.num_bad_epochs = 0
            self.lr = init_lr
